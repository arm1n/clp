    ...
    /** ROW 3 */
    {
      ...
      C: {
        ...
        buttons: [
            ...
            mode: "POPUP",
            path: "/units",
            file: "/units/caut_lt/c3_d4_units.html",
          },
				],
...
export const DISPLAY_FAULT_MSG = [
  ...
  },
  {
	...
	{
    name: "INOPERATIVE PA CHIME",
    file: "./apps/main/config/dashboard/display-fault-msg/inop_pa_chime.html",
    buttons: [],
  },
  {
    name: "PITCH",
  ...
  /* SHOW */
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        path: "/unit-location/cockpit-instruments",
        mode: "INTERNAL",
      },
      {
        name: "C/B LOCATION",
