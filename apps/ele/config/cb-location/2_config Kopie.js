...
export const DATA_SET = [
          ...
          units: [
            {
              ...
              access: { path: "./units/uf/units/avio_cooling_fans_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          ...
          units: [
            { 
							...
							access: { path: "./units/wd/units/ifc_fgm_loc.html", mode: "INLINE"},
						},
        ...
        data: {
          ...
          units: [
            ...
            { unit: "./units/wd/units/rcau.html",
							access: { path: "./units/wd/units/rcau_loc.html", mode: "INLINE"},
						},
          ],
        },
      },
          ...
          units: [
            {
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/ancu_loc.html", mode: "INLINE" },
            },
						{
              unit: "./units/uf/units/nvs_cb_box.html",
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/nvs_cb_box_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
      {
        ...
        data: {
          ...
          units: [
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/wd/units/pass_add_amp_loc.html", mode: "INLINE" },
            },
						{
              unit: "./units/wd/units/dpas.html",
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/wd/units/dpas_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
    ...
    nodes: [
      {
        ...
        data: {
          ...
          units: [
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/apu_gcu_loc.html", mode: "INLINE" },
            },
        ...
        data: {
          ...
          units: [
            { unit: "./units/eng/units/ac_gen_all.html" },
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/ac_gcu_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
      {
        id: "epcu",
        text: "Electrical Power Control Unit",
        data: {
          panels: {
            AC: null,
            AVIONICS: null,
            ...
            RIGHT: "./units/ele/cb-location/desc/chapter_24/epcu/right.html",
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/ele/desc/epcu_info.html", mode: "POPUP" },
            },
          ],
        },
      },
      ...
      },
      {
        ...
        data: {
          ...
          units: [
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/wd/units/fire_cont_amp_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/flap_cont_unit_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: "./units/ele/cb-location/desc/chapter_27/fcecu/right.html",
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/fcecu_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/wd/units/ifc_spm_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/fc/units/yaw_damper_act_info.html", mode: "INLINE" },
            },
          ],
        },
      },
  ...
  /* CHAPTER 30 */
  {
    ...
    nodes: [
        ...
        data: {
          panels: {
            ...
            RIGHT: "./units/ele/cb-location/desc/chapter_30/aic/right.html",
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/wd/units/anti_ice_cont_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
      ...
      {
        id: "pdmt",
        text: "Propeller De-icing Timer Monitor",
        data: {
          panels: {
            AC: null,
            AVIONICS: null,
            ...
            RIGHT: "./units/ele/cb-location/desc/chapter_30/pdmt/right.html",
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/tmcu_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
      {
        id: "tmu",
        text: "Airframe Timer and Monitor Unit",
        data: {
          panels: {
            AC: null,
            AVIONICS: null,
        ...
        data: {
          ...
          units: [
            { unit: "./units/gear/units/wheel_speed_tx.html" },
              ...
              /* info: { path: "./units/uf/units/epcu.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/anti_skid_unit_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: "./units/ele/cb-location/desc/chapter_32/pseu/right.html",
              ...
              info: { path: "./units/wd/units/pseu_info.html", mode: "INLINE" }, 
              access: { path: "./units/wd/units/pseu_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              access: { path: "./units/antenna/units/adf_units_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              /* info: { path: "./units/wd/units/adf_units_info.html", mode: "INLINE" }, */
              access: { path: "./units/uf/units/ahru_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
        ...
        data: {
          panels: {
            ...
            RIGHT: null,
              ...
              /* info: { path: "./units/wd/units/adf_units_info.html", mode: "INLINE" }, */
              access: { path: "./units/antenna/units/atc_units_loc.html", mode: "INLINE" },
            },
          ],
        },
      },
  ...
  /* CHAPTER 61 */
  {
    ...
    nodes: [
      ...
      {
        id: "bft",
        text: "Pitch-Control-Unit Ground Beta-Feedback Transducer (BFT)",
        data: {
          panels: {
            AC: null,
            AVIONICS: null,
      ...
      {
        id: "pecu",
        text: "Propeller Electronic Control Unit",
        data: {
          panels: {
            AC: null,
            AVIONICS: null,
    ...
    nodes: [
      {
        ...
        data: {
          ...
          units: [{ unit: "./units/eng/units/ign_exciter_igniter.html" }],
        },
      },
    ],
  },
