...
export const DATA_SET = [
  ...
  },
  {
    ...
    desc: "./units/wd/desc/ifc_iop.html",
		access: {
      path: "./units/wd/units/ifc_iop_loc.html",
  ...
  },
  {
    ...
    desc: "../units/uf/desc/ac_gcu.html",
		access: {
      path: "./units/uf/units/ac_gcu_loc.html",
      mode: "INLINE", /* INLINE oder POPUP*/
      title: "Location" /* title nur bei POPUP */
    }
  },
 ...
 */
export const SVG_PATH = "./apps/ele/config/ac-system/pic/ac_sys.svg";
 ...
 */
export const INTRO_PATH = "./apps/ele/config/ac-system/desc/intro.html";
