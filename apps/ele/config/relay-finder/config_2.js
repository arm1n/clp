  ...
  /* COCKPIT DOOR REMOTE ACCESS RELAY BOX */
  {
    ...
    data: {
      ...
      unit: "./units/ele/units/rem_access_relay_box.html",
				info: {
      	path: "./units/ele/units/rem_access_relay_box_info.html",
  ...
  /*NVS, CIRCUIT BREAKER BOX*/
  {
    ...
    data: {
      ...
      unit: "./units/uf/units/nvs_cb_box.html",
			info: {
      	path: "./units/uf/units/nvs_cb_box_info.html",
      	mode: "INLINE" /* INLINE oder POPUP*/
    	},
				access: {
      	path: "/units/uf/units/nvs_cb_box_loc.html",
      	mode: "INLINE", /* INLINE oder POPUP*/
      	title: "EPCU FAULT CODES" /* title nur bei POPUP */
    	},
      refs: [
        {
          id: "clp-2335-K1",
