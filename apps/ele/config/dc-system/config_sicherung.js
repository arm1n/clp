...
export const DATA_SET = [
  ...
  },
  {
    ...
    desc: "./units/wd/desc/pseu.html",
		 info: {
      path: "./units/wd/units/pseu_info.html",
      mode: "INLINE" /* INLINE oder POPUP*/
    },
    access: {
      path: "./units/wd/units/pseu_loc.html",
      mode: "INLINE", /* INLINE oder POPUP*/
      title: "INFO" /* title nur bei POPUP */
    }
  },
  {
    id: "clp-dc-cont-k1",
  ...
  },
  {
    ...
    desc: "./units/uf/desc/apu_gcu.html",
		access: {
      path: "./units/uf/units/apu_gcu_loc.html",
      mode: "INLINE", /* INLINE oder POPUP*/
      title: "Location" /* title nur bei POPUP */
    }
  },
  {
    id: "clp-dc-gcu1",
  ...
  },
  {
    ...
    desc: "./units/cockpit/desc/epcu.html",
		 info: {
      path: "./apps/ele/config/desc/epcu_faults.html",
      mode: "POPUP", /* INLINE oder POPUP*/
			title: "Information" /* title nur bei POPUP */
    },
  },
  {
    id: "clp-tru1",
  ...
  {
    id: "clp-tru-cb1",
    unit: "./units/ele/dc-system/units/unit.html",
    desc: "./units/ele/dc-system/desc/desc.html",
  },
  {
    id: "clp-tru-cb2",
    unit: "./units/ele/dc-system/units/unit.html",
 ...
 */
export const SVG_PATH = "./apps/ele/config/dc-system/pic/dc_sys.svg";
 ...
 */
export const DEFAULT_UNIT = "./units/ele/dc-system/units/unit.html";
 ...
 */
export const INTRO_PATH = "./apps/ele/config/dc-system/desc/intro.html";
